          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-10 lg:mb-12">
            ...
            <div className="space-y-3 sm:space-y-4 sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3 sm:space-x-4">
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors p-1" aria-label="Twitter">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                  </svg>
                </a>
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors p-1" aria-label="LinkedIn">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors p-1" aria-label="Facebook">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Features</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Pricing</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Integrations</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Templates</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">API</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">For Teams</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">For Agencies</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">For Startups</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">For Enterprise</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Remote Work</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Help Center</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Contact Us</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Webinars</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Community</a></li>
                <li><a href="#" className="text-gray-700 hover:text-gray-900 transition-colors text-xs sm:text-sm block py-1">Status</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-300 pt-6 sm:pt-8">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-6 text-xs sm:text-sm">
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors py-1">Privacy Policy</a>
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors py-1">Terms of Service</a>
                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors py-1">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
